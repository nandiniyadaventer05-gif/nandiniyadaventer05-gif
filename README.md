  ...
  <table width="100%" cellspacing="0" cellpadding="0" style="border-collapse: separate; border-spacing: 12px; border: none; background: transparent;">
    <tr>
      <td width="33%" align="center" style="background-color: #121215; border: 1px solid #A855F744; border-radius: 12px; padding: 18px 12px;">
        ...
        <div style="font-size: 28px; font-weight: 800; color: #A855F7; margin-top: 4px;">334</div>
      ...
      <td width="33%" align="center" style="background-color: #121215; border: 1px solid #27272a; border-radius: 12px; padding: 18px 12px;">
        ...
        <div style="font-size: 28px; font-weight: 800; color: #f4f4f5; margin-top: 4px;">16</div>
      ...
      <td width="33%" align="center" style="background-color: #121215; border: 1px solid #27272a; border-radius: 12px; padding: 18px 12px;">
        ...
        <div style="font-size: 28px; font-weight: 800; color: #06b6d4; margin-top: 4px;">1</div>
...
<div align="center" style="max-width: 800px; margin: 0 auto;">
  <div style="font-size: 12px; text-transform: uppercase; letter-spacing: 2px; color: #a1a1aa; font-weight: 700; margin-bottom: 12px;">⚡ TECH STACK & ECOSYSTEM</div>
    ...
    <div style="background-color: #121215; border: 1px solid #27272a; border-radius: 12px; padding: 16px; margin-bottom: 12px; text-align: left;">
      <div style="font-size: 11px; text-transform: uppercase; letter-spacing: 1.5px; color: #A855F7; font-weight: 700; margin-bottom: 8px;">// Frontend & UI</div>
    ...
    <tr>
        <td width="50%" valign="top" style="background-color: #121215; border: 1px solid #27272a; border-radius: 12px; padding: 16px; text-align: left;">
          <div style="font-size: 14px; font-weight: 700; color: #A855F7;">
            <a href="https://github.com/nandiniyadaventer05-gif/nandiniyadaventer05-gif" style="color: #A855F7; text-decoration: none;">📦 nandiniyadaventer05-gif</a>
          </div>
        ...
        <td width="50%" valign="top" style="background-color: #121215; border: 1px solid #27272a; border-radius: 12px; padding: 16px; text-align: left;">
          <div style="font-size: 14px; font-weight: 700; color: #A855F7;">
            <a href="https://github.com/nandiniyadaventer05-gif/OJT-PROJECT" style="color: #A855F7; text-decoration: none;">📦 OJT-PROJECT</a>
          </div>
          <div style="font-size: 12px; color: #a1a1aa; margin: 6px 0 10px 0; min-height: 36px; line-height: 1.4;">
            Open source repository project.
          </div>
        ...
        <td width="50%" valign="top" style="background-color: #121215; border: 1px solid #27272a; border-radius: 12px; padding: 16px; text-align: left;">
          <div style="font-size: 14px; font-weight: 700; color: #A855F7;">
            <a href="https://github.com/nandiniyadaventer05-gif/ecommerce-automation-n8n" style="color: #A855F7; text-decoration: none;">📦 ecommerce-automation-n8n</a>
          </div>
          <div style="font-size: 12px; color: #a1a1aa; margin: 6px 0 10px 0; min-height: 36px; line-height: 1.4;">
            Open source repository project.
          </div>
        ...
        <td width="50%" valign="top" style="background-color: #121215; border: 1px solid #27272a; border-radius: 12px; padding: 16px; text-align: left;">
          <div style="font-size: 14px; font-weight: 700; color: #A855F7;">
            <a href="https://github.com/nandiniyadaventer05-gif/smart-business-automation" style="color: #A855F7; text-decoration: none;">📦 smart-business-automation</a>
          </div>
          <div style="font-size: 12px; color: #a1a1aa; margin: 6px 0 10px 0; min-height: 36px; line-height: 1.4;">
            Open source repository project.
          </div>
        ...
        <td width="50%" valign="top" style="background-color: #121215; border: 1px solid #27272a; border-radius: 12px; padding: 16px; text-align: left;">
          <div style="font-size: 14px; font-weight: 700; color: #A855F7;">
            <a href="https://github.com/nandiniyadaventer05-gif/n8n-automation-hub" style="color: #A855F7; text-decoration: none;">📦 n8n-automation-hub</a>
          </div>
          <div style="font-size: 12px; color: #a1a1aa; margin: 6px 0 10px 0; min-height: 36px; line-height: 1.4;">
            Open source repository project.
          </div>
        ...
        <td width="50%" valign="top" style="background-color: #121215; border: 1px solid #27272a; border-radius: 12px; padding: 16px; text-align: left;">
          <div style="font-size: 14px; font-weight: 700; color: #A855F7;">
            <a href="https://github.com/nandiniyadaventer05-gif/-Kulhad-Chai-Full-Stack-Web-App" style="color: #A855F7; text-decoration: none;">📦 -Kulhad-Chai-Full-Stack-Web-App</a>
          </div>
          <div style="font-size: 12px; color: #a1a1aa; margin: 6px 0 10px 0; min-height: 36px; line-height: 1.4;">
            Open source repository project.
          </div>
